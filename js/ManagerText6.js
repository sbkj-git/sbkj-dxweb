$(document).ready(function(){
    ...
    //页面初次渲染加载数据
        ...
        render(data2);
        judgePower();
        pageChange("get.dxWeb.noticeList",data2,"pagination12",url);
        //封装分页
    ...
    function render(data) {
        if (data.dxWebList&&data.dxWebList.length > 0) {
            ...
            $.each(data.dxWebList, function (i, item) {
                ...
                str += '<td>' + item.release_time + '</td><td style="color:#48a4ea;"><span class="isDelete" data-id="' + item.id + '">删除</span>&nbsp;&nbsp;<span data-id="' + item.id + '" class="isLook">查看</span>&nbsp;&nbsp;<span class="isEdit" data-id="' + item.id + '">编辑</span></td>';
