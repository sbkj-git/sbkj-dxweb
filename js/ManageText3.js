         ...
         function render(data) {
             if(data.dxWebList){
                ...
                $.each(data.dxWebList, function (i, item) {
                    ...
                    str += '<td><div class="checkbox checkbox-primary"><input type="checkbox" class="styled styled-primary t1" id="' + item.id + '"   aria-label="Single checkbox Two" data-id="' + item.id + '"><label for="' + item.id + '">' + item.title + '</label></div></td><td>' + item.author + '</td><td>' + item.browse + '</td>';
                    if (item.is_ups == 1) {
                        str += "<td>&#10003;</td>";
                    } else {
                        str += "<td>&#10007;</td>"
                ...
                $(".toTop").unbind('click').bind("click",function(){ 
                    ...
                    par = "appsercet=" + newAppsercet + "&method=get.dxWeb.updateHelp&isUP=1";
                ...
                $(".toDown").unbind('click').bind("click",function(){ 
                    ...
                    var id = $(this).attr("data-id");
                    par = "appsercet=" + newAppsercet + "&method=get.dxWeb.updateHelp&isUP=2";
